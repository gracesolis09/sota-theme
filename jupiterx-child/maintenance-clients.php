<?php
/***
 * Template Name: Maintenance Clients
 */
$custom_query = new WP_Query('posts_per_page=-1&category_name=maintenance-clients');
get_header();
?>
<div class="main-wrap">
      ...
      <div class="container custom-width">
         ...
         <div class="row">
                            ...
                            while ($custom_query->have_posts()) : $custom_query->the_post();
                                ...
                                if ($postCats) {
                                    foreach($postCats as $cat) {
										if ( $cat->term_id != get_category_by_slug('maintenance-clients')->term_id ) {
                                        	$all_cat[] = $cat->term_id;
										}
                                    }
                                }
            ...
            <?php
                  ...
                  'post_type' => 'post',
                  'posts_per_page' => 9,
                  'category_name' => 'maintenance-clients'
               );
               ...
               ?>
                <div class="raven-posts raven-grid raven-grid-3 raven-grid-tablet-2 raven-grid-mobile-1 js-blog-list" data-cat="" data-tag="" data-main-cat="<?php echo get_category_by_slug('maintenance-clients')->term_id; ?>">
                  <?php
